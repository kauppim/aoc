...
public class CrossSearcher
{
    private List<string> searchItems;
    private char[,] sourceArray;

    public CrossSearcher(List<string> searchItems, string sourcePath)
    {
    ...
    private List<List<Tuple<int, int>>> Search(string searchWord) {
        ...
        var newListOfCoordinates = new List<List<Tuple<int, int>>>(); 
        ...
        var middles = new List<Tuple<int,int>>();
        
        // listOfCoordinates.ForEach(x => middles.Add(x[1]));
        // Console.WriteLine($"Sizes: {listOfCoordinates.Count}, {middles.Count}");
        ...
        //             continue;
        //         }
        //         else if (middles[j].Equals(middles[i]))
        //         {
        //             keep = true;
        //             break;
        //         }
        ...
        //     if (keep == true)
        //     {
        //         newListOfCoordinates.Add(listOfCoordinates[i]);
        //     }
        // }

        // for (int i = 0; i < middles.Count; i++)
        // {
        //     if (sourceArray[middles[i].Item1, middles[i].Item2] == 'A') {
        //         newListOfCoordinates.Add(listOfCoordinates[i]);
        //     }
        // }
        // Console.WriteLine($"Sizes: {newListOfCoordinates.Count}");
        ...
        result.ForEach(x => middles.Add(x[1]));
        for (int i = 0; i < middles.Count; i++)
        {
            var keep = false;
            for (int j = 0; j < middles.Count; j++)
            ...
            if (keep == true)
            {
                newListOfCoordinates.Add(result[i]);
            }
        }
        Console.WriteLine($"Sizes: {newListOfCoordinates.Count}");
